    ...
    <section>
      <div class="bg-primary-subtle py-lg-12 py-5">
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-6">
              <h2 class="fs-12 fw-bolder ">I'm a Dark Eldar Snob</h2>
              <div class="d-flex mt-4 gap-3 flex-sm-nowrap flex-wrap">
                <h5>I also have anger management issues so I play World Eaters too!</h5>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="">
      ...
      <div class="container-fluid">
        <div class="row justify-content-between">
          <div class="col-lg-5 mb-5 mb-lg-0">
            <h2 class="fs-10 fw-bolder mb-3">iToysoldiers Today</h2>
            <p class="fs-4 mb-0">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-5">
                  ...
                  <p class="mb-0 fs-4">When this iteration of iTS started</p>
                </div>
                <div class="">
                  <p class="text-primary text-uppercase fs-2 fw-bold mb-0">collection</p>
                  <h3 class="fs-12 fw-semibold "><?php print $vn_count; ?></h3>
                  <p class="mb-0 fs-4">How many items are in my collection</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-5">
                  <p class="text-primary text-uppercase fs-2 fw-bold mb-0">cost</p>
                  <h3 class="fs-12 fw-semibold ">$<?php print number_format((float)$vn_cost, 2, '.', ','); ?></h3>
                  <p class="mb-0 fs-4">An estimate on what I've spent on my collection</p>
                </div>
              </div>
            </div>
          </div>
	...
	<!-- /.modal-dialog -->
          ...
          <div class="col-lg-6">
            <div class="border p-7 p-md-5 rounded-3">
              <h3 class="fs-7 fw-semibold text-dark">Change Log</h3>
              <div class="owl-carousel testimonial-carousel owl-theme">
				<!-- Put new version block here -->
			  <div class="item">
                  <div>
                    <div class="d-flex align-items-center gap-3 my-4">
                      <p class="fs-4 fw-semibold mb-0 text-dark">2024-11-26: 1.1.?</p>
                    </div>
					<div class="d-flex align-items-center gap-3 my-4">
                      <p class="fs-4 fw-semibold mb-0 text-dark">New Themey Theme</p>
                    </div>
                    <p class="fs-5 border-bottom pb-4 mb-4">
                      I've applied the Modernize Admin theme to the site and it looks snazzy.
                    </p>
                ...
                <div class="item">
                  <div>
                    <div class="d-flex align-items-center gap-3 my-4">
                      <p class="fs-4 fw-semibold mb-0 text-dark">2024-11-08: 1.0.29</p>
                    </div>
					<div class="d-flex align-items-center gap-3 my-4">
                      <p class="fs-4 fw-semibold mb-0 text-dark">Minimal Viable Product</p>
                    </div>
                    <p class="fs-5 border-bottom pb-4 mb-4">
