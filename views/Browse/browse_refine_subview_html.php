 ...
 */
	...
	if(is_array($va_facets) && sizeof($va_facets)){
		...
		print "<a href='#' class='nav-link' id='bRefineClose' onclick='jQuery(\"#bRefine\").toggle(); return false;'><span class='glyphicon glyphicon-remove-circle'></span></a>";
...
?>
				...
				print "<h4 class='mt-1'>".$va_facet_info['label_singular']."</h4>"; 
