						...
						while ($count <= $page_count) {
							...
							if ($pag_start == $vn_start + $vn_results_output) {
                                if ($count == 1) {
                                    ...
                                    print '<a class="page-link disabled">Previous</a>';
                                    print '</li>';
									...
									print '<li class="page-item">';
                                	print caNavLink($this->request, _t($count + 1), 'page-link', '*', '*', '*', array('s' => ($count) * $vn_hits_per_block, 'key' => $vs_browse_key, 'view' => $vs_current_view, 'sort' => $vs_current_sort, '_advanced' => $this->getVar('is_advanced') ? 1  : 0));
							    	print '</li>';

									print '<li class="page-item">';
                                	print '<a class="page-link disabled">...</a>';
							    	print '</li>';

									print '<li class="page-item">';
                                	print caNavLink($this->request, _t('Next'), 'page-link', '*', '*', '*', array('s' => ($count) * $vn_hits_per_block, 'key' => $vs_browse_key, 'view' => $vs_current_view, 'sort' => $vs_current_sort, '_advanced' => $this->getVar('is_advanced') ? 1  : 0));
							    	print '</li>';
                                } elseif ($count == $page_count) {
                                    print '<li class="page-item">';
                                    print caNavLink($this->request, _t('Previous'), 'page-link', '*', '*', '*', array('s' => ($count -2) * $vn_hits_per_block, 'key' => $vs_browse_key, 'view' => $vs_current_view, 'sort' => $vs_current_sort, '_advanced' => $this->getVar('is_advanced') ? 1  : 0));
                                    print '</li>';
									...
									print '<li class="page-item">';
                                	print caNavLink($this->request, _t($count -1), 'page-link', '*', '*', '*', array('s' => ($count -2) * $vn_hits_per_block, 'key' => $vs_browse_key, 'view' => $vs_current_view, 'sort' => $vs_current_sort, '_advanced' => $this->getVar('is_advanced') ? 1  : 0));
							    	print '</li>';
									...
									print '<li class="page-item">';
                                	print '<a class="page-link disabled">Next</a>';
							    	print '</li>';
								} elseif ($count == $page_count - 1) {
                                    print '<li class="page-item">';
                                    print caNavLink($this->request, _t('Previous'), 'page-link', '*', '*', '*', array('s' => ($count -2) * $vn_hits_per_block, 'key' => $vs_browse_key, 'view' => $vs_current_view, 'sort' => $vs_current_sort, '_advanced' => $this->getVar('is_advanced') ? 1  : 0));
                                    print '</li>';
